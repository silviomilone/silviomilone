...
var items = [];
    $.getJSON("https://api.flickr.com/services/rest/?method=flickr.photosets.getInfos" + "&api_key=7ff7a5e980813cedb8ee459831c455bf" + "&photoset_id=" + setid + "&user_id=143250961%40N04" + "&extras=" + "&format=json&nojsoncallback=1", function(data) {
...
return $.getJSON("https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos" + "&api_key=7ff7a5e980813cedb8ee459831c455bf" + "&photoset_id=" + setid + "&user_id=143250961%40N04" + "&extras=" + "&format=json&nojsoncallback=1").then(function(data){
                    $('<div class=".swiper-container"><img src="' + photo + '"><h2>' + data.photo.title._content + '</h2></div>').appendTo(#diapo .swiper-wrapper");
        );
